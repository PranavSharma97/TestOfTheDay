...
public class PreviousTestsRightQuestions extends ActionBarActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_previoustestsright_questions);
...
//				submitButton.setText("Try Again");
	...
	void showDialog() {
		...
		{
			if(tempIndex==PreviousTestsActivity.rightIndex-1)
				showTestEndDialog();
			else 
				return;
		}
...
//				});
	...
	{
		questiondAndOptions = PreviousTestsActivity.rightQuestions;
	}
